...
<div id="main">
    ...
    <div id="site_content">
        ...
        <h1>Rezerwacja numer <?php $_REQUEST['id'] ?></h1>
        <?php if($data){ ?>
            <table>
                <tr>
                    <th>ID</th>
                    ...
                    <tr>
                        <?php foreach($data as $val){ ?>
                            <td><?php echo $val ?></td>
                        <?php } ?>
                        <td><a href="index.php?action=adminPanel&amp;id=<?php echo $data['id'] ?>&amp;subaction=edit"><img src="pictures/edit.jpg" alt="edit"></a></td>
                        <td><a href="index.php?action=adminPanel&amp;id=<?php echo $data['id'] ?>&amp;subaction=delete"><img src="pictures/delete.jpg" alt="edit"></a></td>
                    </tr>
